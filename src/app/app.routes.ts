...
export const routes: Routes = [
  ...
  {path:'sirket-ekle',canActivate:[authGuard],loadComponent:()=>import('./pages/sirket-ekle/sirket-ekle').then(m=>m.SirketEkle)},
  ...
  {path:'konut-ekle',canActivate:[authGuard],loadComponent:()=>import('./pages/konut-ekle/konut-ekle').then(m=>m.KonutEkle)},
